              ...
              <div>
                <div className="lg:w-[570px]">  
                  ...
                  <p className="text__para">
                    ...
                    facere consequatur cupiditate nisi quibusdam quod provident labore 
                    illum vitae ea, dolorum sapiente maiores itaque.
        ...
        <div className="container">
          <div className="lg:w-[470px] mx-auto">
            ...
            <p className="text__para text-center">
              ...
              unmatched, expert healthcare services for you and your family.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-[30px] mt-[30px] lg:mt-[55px]">
            ...
            <div className="mt-[30px]">
              ...
              <p className="text-[16px] leadinf-7 text-textColor font-[400] mt-4 text-center">
                World-class care for everyone. We offer unmatched, expert healthcare services. From the lab to the clinic.
              </p>
      ...
      <section>
        <div className="container">
          <div className='xl:w-[470px] mx-auto'>
            ...
            <p className='text__para text-center'>World-class care for everyone. Our health System offers unmatched, expert healthcare services for you and your family.
            </p>
          </div>
          <ServiceList/> 
        </div>
